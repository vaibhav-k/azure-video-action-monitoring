...
def to_console_text(report: ActionReport, video_name: str) -> str:
    ...
    if not report.events:
        ...
        lines.append(
            f"{'Start':>8}  {'End':>8}  {'Source':<10}  {'Matched term':<20}  "
        ...
        for e in report.events:
            ...
            lines.append(
                ...
                f"{e.source:<10}  {e.matched_term:<20}  {conf:<10}  {e.evidence or '-'}"
            )
    return "\n".join(lines)
...
def to_console_text_all(report: AllActionsReport, video_name: str) -> str:
    ...
    lines.append("")
    lines.append(
        f"{'Start':>8}  {'End':>8}  {'Source':<10}  {'Action':<24}  "
        f"{'Confidence':<10}  Evidence"
    )
    for a in report.actions:
        ...
        lines.append(
            ...
            f"{a.source:<10}  {a.name:<24}  {conf:<10}  {a.evidence or '-'}"
        )
    return "\n".join(lines)
